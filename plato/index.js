// Things that the back-end / Static site generator needs to do:

// DEV RUN
// 1) Fetch all remote data and build local json
// 2) Build routes config file
// 3) Build dynamic routes file
// 4) Build all static pages
// 5) Start dev server
// 6) start watching files

// WATCH
// 1) Watch /templates and /pages and rebuild if needed
// 2) Watch Layout and partials and rebuild all page if changed
// 3) Dev server
...
// 2) Build routes config file
// 3) Build dynamic routes file
// 4) Build Final JS and CSS and manifest
// 4) Build all static pages using the final manifest
// 5) Critical CSS
// 6) Minify HTML
...
// ADD MIDDLEWARE SUPPORT TO REWRITE DATA
